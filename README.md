...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>A string representation of a list of up to 10 key value pairs to be used as environment variables within the tasks. Variables are separated by ,, and key value pairs by ==. For example 'Key1==Value1,,Key2==Value2'</td>
      <td></td>
      <td>no</td>
      <td></td>
    </tr>
    <tr>
      ...
      <td>A CommaDelimitedList of up to 10 key value pairs to be used as environment variables within the tasks. The values should be the stack name of a <a href="https://www.npmjs.com/package/@cfn-modules/secret">secret module</a>. For example 'Key1=SecretStackName'
      </td>
      <td></td>
      <td>no</td>
      <td></td>
